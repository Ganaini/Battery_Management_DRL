...
if __name__ == '__main__':
    ...
    df_predictons.to_csv(r'E:\Mahmoud\PhD_Work\Presentations\March_25_Forecast\Supervised_Predictions_101.csv')
    
    # saving model parameters to use in initializing the DRL model parameters    
    save_path = r'E:\Mahmoud\PhD_Work\Presentations\March_25_Forecast\Models\A_day_trained_101.pth'
